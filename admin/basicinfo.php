...
<?php include_once 'sidebar.php' ?>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputemail" name="email"  placeholder="Enter E-Mail Address">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>

  <div class="form-group">
    <label for="phone">Phone No.</label>
    <input type="text" class="form-control" id="exampleInputphone" name="phone" placeholder="Enter Phone No">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputsocial" name="social"  placeholder="Enter Social account Link">
    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
  </div>
